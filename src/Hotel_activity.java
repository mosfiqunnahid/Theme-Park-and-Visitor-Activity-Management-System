 ...
 * @author User
 */
public class Hotel_activity extends javax.swing.JFrame {
 Connection conn;
    ResultSet rs;
    PreparedStatement pst;
    /**
     * Creates new form Hotel_activity
     */
    public Hotel_activity() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Cname", "Phone", "Date", "Parkno", "Time", "Room", "Start ", "End "
            }
        ) {
   ...
   jTable1.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hotel_activity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
