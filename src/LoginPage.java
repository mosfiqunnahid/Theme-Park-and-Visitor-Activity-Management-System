...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Visitor", "Admin" }));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Login As User_48px.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
         String sql="select * from visitor where User=? and Pass=?";
        try{
